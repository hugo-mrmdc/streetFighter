...
export class BaseBleu extends Fighter {
  constructor(x, y, direction, playerId, onAttackHit, entityList) {
    super('BASE', x, y, direction, playerId, onAttackHit);
    this.entityList = entityList
    this.tornadoCooldown = 0;
    this.image = document.querySelector('img[alt="base"]');
    ...
    this.frame = new Map([
      ['idle-1', [[[1, 1, 18, 31], [33, 83]], PushBox.IDLE, HurtBox.IDLE]],
      ...
      ['forwards-1', [[[20, 7, 19, 25], [27, 81]], PushBox.IDLE, HurtBox.FORWARD]],
      ['forwards-2', [[[40, 7, 18, 25], [35, 86]], PushBox.IDLE, HurtBox.FORWARD]],
      ['forwards-3', [[[60, 7, 19, 25], [35, 89]], PushBox.IDLE, HurtBox.FORWARD]],
      ['forwards-4', [[[80, 7, 19, 25], [29, 89]], PushBox.IDLE, HurtBox.FORWARD]],
      ...
      ['crouch-3', [[[60, 7, 19, 25], [35, 55]], PushBox.CROUCH, HurtBox.CROUCH]],
      ...
      ['light-punch-1', [[[1, 91, 52, 47], [60, 140]], PushBox.IDLE, HurtBox.IDLE]],
      ['light-punch-2', [[[54, 91, 52, 47], [60, 140]], PushBox.IDLE, HurtBox.IDLE, [0, -100, 100, 100]]],
      ['light-punch-3', [[[107, 91, 52, 47], [60, 140]], PushBox.IDLE, HurtBox.IDLE]],

      ['med-punch-1', [[[1, 139, 51, 34], [28, 82]], PushBox.IDLE, HurtBox.IDLE]],
      ['med-punch-2', [[[53, 139, 51, 34], [29, 82]], PushBox.IDLE, HurtBox.PUNCH]],
      ['med-punch-3', [[[105, 139, 51, 34], [24, 82]], PushBox.IDLE, HurtBox.PUNCH, [17, -70, 68, 14]]],
      ['med-punch-4', [[[105, 139, 51, 34], [24, 82]], PushBox.IDLE, HurtBox.PUNCH, [17, -70, 68, 14]]],
  ...
  */
    ...
    this.animations = {
      [FighterState.IDLE]: [['idle-1', 68], ['idle-1', 68], ['idle-1', 68], ['idle-1', 68], ['idle-1', 68], ['idle-1', 68]],
      [FighterState.WALK_FORWARD]: [['forwards-1', 65], ['forwards-2', 65], ['forwards-3', 65], ['forwards-4', 65], ['forwards-4', 0], ['forwards-1', 65]],
      [FighterState.WALK_BACKWARD]: [['forwards-4', 65], ['forwards-3', 65], ['forwards-2', 65], ['forwards-1', 65], ['forwards-1', 0], ['forwards-1', 0]],
      [FighterState.JUMP_UP]: [['forwards-2', 65], ['forwards-2', 65], ['forwards-2', 65], ['forwards-2', 65], ['forwards-2', 65], ['jump-6', -1]],
      [FighterState.JUMP_FORWARD]: [['forwards-2', 65], ['forwards-2', 65], ['forwards-2', 65],['forwards-2', 65], ['jump-roll-6', -1]],
      [FighterState.JUMP_BACKWARD]: [['forwards-2', 65],['forwards-2', 65],['forwards-2', 65],['forwards-2', 65], ['jump-roll-1', -1]],
      [FighterState.JUMP_END]: [['forwards-1', 1]],
      [FighterState.CROUCH]: [['crouch-3', 0]],
      [FighterState.JUMP_START]: [['idle-1', 65], ['jump-land', -2]],
      [FighterState.JUMP_LAND]: [['forwards-2', 65], ['jump-land', -2]],
      [FighterState.CROUCH_DOWN]: [['crouch-3', 30], ['crouch-3', 30], ['crouch-3', 30], ['crouch-3', -2]],
      ...
      [FighterState.LIGHT_PUNCH]: [['light-punch-1', 103], ['light-punch-2', 100], ['light-punch-3', 100], ['light-punch-1', -2]],
