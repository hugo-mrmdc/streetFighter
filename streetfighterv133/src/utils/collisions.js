export function rectOverlap(x1,y1,width1,height1,x2,y2,width2,height2){
    return x1 < x2 + width2 && x1 + width1 > x2 && y1 < y2 + height2 && y1 + height1 > y2;
}
export function boxOverlap(box1,box2){
    return rectOverlap(box1.x,box1.y,box1.width,box1.height,box2.x,box2.y,box2.width,box2.height)
}
