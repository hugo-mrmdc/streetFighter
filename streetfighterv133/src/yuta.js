...
export class Yuta extends Fighter {
  constructor(x, y, direction, playerId, onAttackHit, entityList) {
    ...
    this.frame = new Map([
      ...
      ['idle-3', [[[0, 132, 52, 56], [26, 85]], PushBox.IDLE, HurtBox.IDLE]],
      ['idle-4', [[[0, 199, 51, 56], [26.1, 86]], PushBox.IDLE, HurtBox.IDLE]],
      ...
      ['light-punch-1', [[[0, 4300, 49, 55], [10, 75]], PushBox.IDLE, HurtBox.IDLE]],
