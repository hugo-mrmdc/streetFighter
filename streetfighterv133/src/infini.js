...
export class Infini {
    constructor() {
        ...
        this.image = document.querySelector('img[alt="gojoC"]');
        ...
        this.frames = new Map([
            ['black-1', [649, 2109, 294, 167]],
           
            ['void', [72, 208, 768, 176]],
            ['void-1', [346,2291, 294, 166]],
        ...
        this.start = new StartExpansion(
            ...
            [['infini-1', 133], ['infini-2', 133], ['infini-3', 133],['infini-4', 133], ['infini-5', 133], ['infini-6', 133]
            , ['infini-7', 133], ['infini-8', 133],['infini-1', 133], ['infini-2', 133], ['infini-3', 133],['infini-4', 133], ['infini-5', 133], ['infini-6', 133]
            , ['infini-7', 133], ['infini-8', 133],['infini-1', 133], ['infini-2', 133], ['infini-3', 133],['infini-4', 133], ['infini-5', 133], ['infini-6', 133]
            , ['infini-7', 133], ['infini-8', 133], ['infini-9', 200], ['infini-9', 100],['infini-9', 50],['infini-9', 50], ['infini-9', 50],['infini-9', 150],['infini-9', 150], ['infini-9', 150],['infini-9', 150],['infini-9', 150]
    ...
    drawBoat(context, camera) {
        ...
        this.boat.position = {
            x: Math.floor(235 - (camera.position.x / 1)),
            y: Math.floor(-camera.position.y + this.boat.animation[this.boat.animationFrame]),
        }
        this.drawFrame2(context, 'black-1', this.boat.position.x, -10 - camera.position.y,6,10)
        this.drawFrame2(context, 'void-1', this.boat.position.x, 30 - camera.position.y,3,1.3)
    ...
    drawBackground(context, camera) {
        ...
        this.drawBoat(context, camera)
            ...
            this.start.draw(context,Math.floor(235 - (camera.position.x / 1.613445)), 30 - camera.position.y,3,1.3);
